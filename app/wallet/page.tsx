        ...
        <Card className="space-y-4" data-page-child>
          <div className="space-y-1">
            ...
            <p className="sg-text-sm text-[var(--text-secondary)]">
              After saving, you will verify again with 0.001 XLM to the memo wallet.
            </p>
          </div>
          <div className="space-y-2">
      ...
      <section className="space-y-5 pb-4 pt-4" data-page-child>
        <Card className="space-y-4" data-page-child>
          ...
          <p className="sg-text-sm text-[var(--text-muted)]">
            You can link a different Stellar address any time. Doing so will require a new 0.001 XLM verification.
          </p>
      ...
      <Card className="space-y-4" data-page-child>
        <div className="space-y-2">
          ...
          <ol className="sg-text-sm list-decimal space-y-2 pl-4 text-[var(--text-secondary)]">
            ...
            <li>Send 0.001 XLM to the memo wallet with your memo code</li>
        ...
        >
          {checkBusy ? (
            ...
            <span>I’ve sent 0.001 XLM — check now</span>
          )}
        </Button>
        {checkMessage ? (
